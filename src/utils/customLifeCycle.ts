...
// 通知所有组件页面状态发生了变化
function notifyVisibilityChange(lifeCycleName: string, vm: any) {
  // 生命周期函数会存在$options中，通过$options[lifeCycleName]获取生命周期
  const lifeCycles = vm.$options[lifeCycleName]
  console.log('notifyVisibilityChange', lifeCycleName, lifeCycles)
 ...
 * @param {*} rootVm
 */
export default function bind(rootVm: any) {
